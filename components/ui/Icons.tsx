...
export const GrokLogo = ({ className }: { className?: string }) => (
    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M12 2C6.477 2 2 6.477 2 12C2 17.523 6.477 22 12 22C17.523 22 22 17.523 22 12C22 6.477 17.523 2 12 2ZM11.196 18.41L6.364 13.578L7.636 12.306L11.196 15.866L18.707 8.355L17.435 7.083L11.196 13.322V18.41Z" fill="white" transform="rotate(45 12 12)"/>
        <path d="M15.536 7.05L16.95 8.464L12.707 12.707L11.293 11.293L15.536 7.05Z" fill="white"  transform="rotate(45 12 12)"/>
        <path d="M11.5 4.5L12.5 4.5L12.5 9.5L11.5 9.5L11.5 4.5Z" fill="white"  transform="rotate(45 12 12)"/>
...
export const ImagineIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const ThumbsDownIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H20a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-3Z"></path>
  </svg>
);
